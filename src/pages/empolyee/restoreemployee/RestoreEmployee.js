...
import { deleteEmployee ,restoreEmployee } from 'actions/employee/employee';
...
const RestoreEmployee = (props) => {
    const dispatch=useDispatch();
    const { deletedEmployee } = props;
    console.log(deletedEmployee);

    const [listTable, setListTable] = useState(deletedEmployee?.data)

  
     
    const handleRestore =(employeesCode)=>{
        dispatch(restoreEmployee(employeesCode));
    }
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {listTable.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((custInfo,index) => {
                                    const { id, name, email, employeesCode, phoneNumber ,deletedAt} = custInfo;
                                    const SNo =index+1;
                                        ...
                                        >
                                            ...
                                            <Stack direction="row" alignItems="center" spacing={2}>
                                                <Dropdown>
                                                    ...
                                                    {deletedAt != null ?  <Dropdown.Item onClick={()=>handleRestore(employeesCode)}><RefreshIcon />&nbsp;&nbsp;&nbsp;  Restore</Dropdown.Item> :''}
