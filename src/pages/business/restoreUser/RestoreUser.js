...
import { restoreUser } from 'actions/user/user';
...
const RestoreUser = (props) => {
    const dispatch=useDispatch();
    const { deletedUser } = props;
    // console.log(deletedEmployee);

    const [listTable, setListTable] = useState(deletedUser?.data)

  
     
    const handleRestore =(userCode)=>{
        dispatch(restoreUser(userCode));
    }
                                        ...
                                        >
                                            ...
                                            <Stack direction="row" alignItems="center" spacing={2}>
                                                <Dropdown>
                                                   ...
                                                   <Dropdown.Item onClick={()=>handleRestore(userCode)}><RefreshIcon />&nbsp;&nbsp;&nbsp;  Restore</Dropdown.Item> 
